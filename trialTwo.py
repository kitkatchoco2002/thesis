...
MOTOR_RUN_TIME = 4.0    # Time for quick string pull (seconds)
MOTOR_RESET_TIME = 4.0
...
GPIO.gpio_claim_output(h, PIN_REVERSE)
...
dc_position = "down"  # Track current servo position
...
def motor_pull_string():
    """pulls the string by turning the DC motor."""
    print("Motor pulling string...")
